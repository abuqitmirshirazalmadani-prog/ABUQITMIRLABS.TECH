...
export function AnimatedDownload({
  ...
  const containerVariants = {
    hidden: {
      ...
      transition: { duration: 0.2, ease: easing as any },
    },
    visible: {
      opacity: 1,
      y: 0,
    ...
    >
      ...
      <div className="flex items-center mb-2">
        ...
        >
          ...
          >
            <ChevronDown size={24} className="text-[#ccff00]" />
          </motion.div>
          <motion.div
            className="absolute"
        ...
        <div className="relative ml-2 flex-1 max-w-xs">
          ...
          <div className="relative px-4 py-1.5 font-mono font-bold text-sm text-black">
            <div className="flex items-center">
              <div className="flex font-mono font-bold text-black border-l-2 border-[#ccff00] pl-2">
                {displayText.map((letter, i) => (
                  <motion.span
                    key={`${targetText}-${i}`}
                    className={cn("font-mono text-white dark:text-black font-bold", letter === " " ? "w-3" : "")}
      ...
      {/* Thick separator bar */}
      <div className="w-full h-1 bg-[#ccff00] mb-3 rounded-full" />
      ...
      <div className="flex items-center mb-1">
        ...
        <div className="flex ml-6">
          ...
          <div className="w-28 text-left">
            <div className="text-xs font-mono text-gray-400">FILES COPIED</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-32">
          <div className="w-full h-2.5 border border-white/20 bg-transparent rounded-full flex items-center px-0.5">
            <motion.div
              className="h-1 bg-[#ccff00] rounded-full"
              initial={{ width: "0%" }}
              animate={{
      ...
      <div className="w-3/4 h-0.5 bg-[#ccff00]/50 mt-4 rounded-full" />
    </motion.div>
  );
}
